...
\FunctionTok{html\_table}\NormalTok{(}\FunctionTok{html\_element}\NormalTok{(}\FunctionTok{read\_html}\NormalTok{(cran\_packages), }\StringTok{\textquotesingle{}table\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
##  7 2021-11-22 cgrcusum     Continuous Time Generalized Rapid Response CUSUM     
